...
public class RegisterUI extends javax.swing.JFrame {
    ...
    String querry1 = "Insert into Login (UID,Name,Telephone,Address,Username,Password, Email) values(?,?,?,?,?,?,?)";
    String querry2 = "SELECT UID FROM Login ORDER BY UID DESC LIMIT 1";
    String querry3 = "INSERT INTO Login(Username) VALUES(?)";
    /**
    ...
    private void autoUID()
    {
        try {
            st = dbC.prepareStatement(querry2);
            ResultSet set = st.executeQuery();
            if(set.next())
            {
                String result = set.getString("UID");
                int length = result.length();
                String first = result.substring(0,2);
                String sec = result.substring(2,length);
                int n = Integer.parseInt(sec);
                n++;
                String snum = Integer.toString(n);
                String ftext = first+snum;
                jLabel8.setText(ftext);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(No, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            st1 = dbC.prepareStatement(querry1);
            st1.setString(1, jLabel8.getText());
            st1.setString(2, name.getText());
            st1.setString(3, No.getText());
            st1.setString(4, Address.getText());
            st1.setString(5, Username.getText());
            st1.setString(6, Password.getText());
            st1.setString(7, Email.getText());
            st1.executeUpdate();
            
            st2 = dbC.prepareStatement(querry2);
            ResultSet rs = st2.executeQuery();
            
            if(rs.next())
            {
                st3 = dbC.prepareStatement(querry3);
                st3.executeUpdate();
            ...
            {
                JOptionPane.showMessageDialog(rootPane, "Username " + Username + " added successfully");
            }
